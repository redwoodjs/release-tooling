...
describe("getCommitPr", () => {
  ...
  it("works for reverts", () => {
    expect(
      getCommitPr(
        "< 5f89c0176f517b894cb2c3f1ab9cee4c7c207393 Revert \"Revert `@testing-library/jest-dom` v6 upgrade (#9713)\" (#9719)",
      ),
    ).toEqual("9719");
  });

  it("returns `undefined` if it can't find a PR", () => {
    expect(getCommitPr("<   635d6dea677b28993661a2e46659ff8c987b7275 Merge branch 'release/major/v7.0.0'"))
      .toBeUndefined();
  });
});
