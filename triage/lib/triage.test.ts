...
test('defaultGitLogOptions', () => {
  expect(defaultGitLogOptions).toMatchInlineSnapshot(`
    [
      "--oneline",
      "--no-abbrev-commit",
      "--left-right",
...
test('getCommitMilestone', async () => {
  const milestone = await getCommitMilestone("https://github.com/redwoodjs/redwood/pull/9803")
